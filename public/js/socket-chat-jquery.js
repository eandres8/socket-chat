...
function renderizarMensaje(mensaje, yo) {
    ...
    var imgClass = mensaje.nombre !== 'Administrador' ? '<div class="chat-img"><img src="assets/images/users/1.jpg" alt="user" /></div>' : '';
